...
/**
 * Siddhi Function for hello.
 */
public class helloFunction extends FunctionExecutor {

    // conversion equivalencies
    private static final double KILOMETERS_PER_MILE = 1.609344;

    /**
     * The initialization method for hello, this method will be called before the other methods.
     *
       ...
       //Sample code to convert mile to km
        ...
        if (!((attributeType == Attribute.Type.DOUBLE)
            ...
            throw new ExecutionPlanValidationException("Invalid parameter type found " +
                    "for the argument of hello function, " +
    ...
    protected Object execute(Object data) {
        ...
        if (data != null) {
            ...
            throw new ExecutionPlanRuntimeException("Input to the hello function cannot be null");
        }
        return null;
    }
